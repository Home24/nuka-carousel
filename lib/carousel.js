...
var _lodashUnionBy = require('lodash/unionBy');

var _lodashUnionBy2 = _interopRequireDefault(_lodashUnionBy);
...
var Carousel = _react2['default'].createClass({
  ...
  addToLazyLoadList: function addToLazyLoadList() {
    ...
    var merged = (0, _lodashUnionBy2['default'])(lazyLoadList, nextLoadedSlides, function (slide) {
      return slide.key;
    });
