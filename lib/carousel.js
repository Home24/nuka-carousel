...
var Carousel = _react2['default'].createClass({
  ...
  getLastSlide: function getLastSlide() {
    ...
    var res = (Math.ceil(childrenCount / slidesToScroll) - 1) * slidesToScroll;

    return this.props.stickToEnd ? childrenCount - slidesToShow : res;
  },
  ...
  setLazyLoadList: function setLazyLoadList() {
    ...
    var loadedSlides = children.slice(currentSlideIndex, currentSlideIndex + slidesToShow + 1).map(function (slide) {
      return slide.key;
    });
  ...
  addToLazyLoadList: function addToLazyLoadList() {
    ...
    var nextLoadedSlides = children.slice(selectedSlideIndex, selectedSlideIndex + slidesToShow + 1).map(function (slide) {
      return slide.key;
    });
