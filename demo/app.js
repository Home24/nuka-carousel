    ...
    return (
      <div style={{width: '50%', margin: 'auto'}}>
        <Carousel
          ...
          <img src="http://placehold.it/400x400&text=slide1"/>
          <img src="http://placehold.it/400x400&text=slide2"/>
          <img src="http://placehold.it/400x400&text=slide3"/>
          <img src="http://placehold.it/400x400&text=slide4"/>
          <img src="http://placehold.it/400x400&text=slide5"/>
          <img src="http://placehold.it/400x400&text=slide6"/>
        </Carousel>
